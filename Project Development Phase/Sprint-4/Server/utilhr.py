...
def get_attrition(age,distancefromhome,education,joblevel,monthlyincome,numcompaniesworked,over18,percentsalaryhike,stockoptionlevel,totalworkingyears,trainingtimeslastyear,yearsatcompany,yearssincelastpromotion,yearswithcurrmanager,travel,dept,edu,gender,jobrole,maritalstatus):
    try:
    ...
    x[0] = age
    x[1] = distancefromhome
    x[2] = education
    x[3] = joblevel
    x[4] = monthlyincome
    x[5] = numcompaniesworked
    x[6] = over18
    x[7] = percentsalaryhike
    x[8] = stockoptionlevel
    x[9] = totalworkingyears
    x[10] = trainingtimeslastyear
    x[11] = yearsatcompany
    x[12] = yearssincelastpromotion
    x[13] = yearswithcurrmanager
